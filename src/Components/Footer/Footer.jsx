        ...
        <footer id='footer' className='text-white' style={{ backgroundColor: '#123F1E' }}>
            ...
            <div>
                ...
                <div className='text-center flex items-center h-12'>
                    <span className='text-xs  w-full block text-gray-300 tracking-wider'>© 2023 Developed By <a className='hover:underline' href="https://github.com/mdshamsh20" target="_blank" rel="noopener noreferrer"> Md Shamsuzzama </a></span>
                </div>
            </div>
        </footer>
    );
